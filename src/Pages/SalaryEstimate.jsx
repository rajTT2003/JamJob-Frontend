    ...
    <div className=' max-w-screen-2xl container mx-auto xl:px-24 px-4'>
        ...
        <div className='mt-5 '>
            <div className='search-box p-2 text-center mb-2'>
                ...
                className='py-2 pl-3 border focus:outline-none lg:w-6/12
                mb-4 w-full focus-within:ring-2 focus-within:ring-inset focus-within:ring-green'
                onChange={(e) => setSearchText(e.target.value)}/>
                <button 
                onClick={handleSearch}
                className='bg-green text-white font-semibold px-8 py-2 rounded-sm mb-4'>Search</button>
            </div>
        </div>
        {/* SALARY DISPLAY CARD */}
